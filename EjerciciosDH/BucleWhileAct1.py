#Simulación de juego con dados en Python. Este ejercicio combina el uso de funciones del módulo random, estructuras de control como bucles (while) y condicionales, además de trabajar con variables para simular un juego en el que el puntaje se acumula mediante tiradas de dados.
...
#Dentro del while:
#uardar en la variable llamada dado el resultado de la función randint(1, 6).
...
dado = 0 # para guardar el número que salió en una tirada.
contador = 0 # para guardar la cantidad de tiradas.
puntaje = 0 # para acumular la suma de los dados.
